...
public class ExamplePanel extends JPanel
{
	...
	public ExamplePanel(InputStream databaseStream, JLayeredPane layeredPane,
		ResultReporter.Handler resultsHandler, String s, Font font)
	{
...
//			});
		...
		final ResultsPanel results4 = new ResultsPanel(list, "\u00b12 strokes",
			KanjiInfo.MatchAlgorithm.FUZZY_2OUT, handler, font);
		resultsGrid.add(results4);
		
		final ResultsPanel results5 = new ResultsPanel(list, "\u00b12 strokes",
				KanjiInfo.MatchAlgorithm.FUZZY_2OUT, handler, font);
			resultsGrid.add(results5);
