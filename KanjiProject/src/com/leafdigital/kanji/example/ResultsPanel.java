...
public class ResultsPanel extends JPanel implements KanjiPanel.Handler
{
	...
	public ResultsPanel(KanjiList kanjiList, String title,
			KanjiInfo.MatchAlgorithm algo, Handler handler , Font font)
	{
		...
		boxes[0].setFont(getSuitableFont(120, font));
		outer.add(boxes[0], BorderLayout.NORTH);
		//Font f = getSuitableFont(60);
		Font f = getSuitableFont(80,font);
		...
		//Font f = getSuitableFont(40);
		f = getSuitableFont(50,font);
	...
	private static Font getSuitableFont(int size, Font font)
	{	
		if (font == null){
			...
			float f = size;
			Font newfont = font.deriveFont(f);
			return newfont;
		}
	}
